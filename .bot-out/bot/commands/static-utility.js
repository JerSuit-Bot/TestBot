...
(0, framework_1.staticCommand)({
    ...
    builder: (b) => b.addIntegerOption((o) => o.setName('max').setDescription('Maximum value (default 100)').setMinValue(2).setMaxValue(10000)),
});
(0, framework_1.staticCommand)({
    name: 'random',
...
(0, framework_1.staticCommand)({
    ...
    content: (i) => {
        ...
        if (!input)
            return 'Provide some text to reverse.';
...
(0, framework_1.staticCommand)({
    ...
    content: (i) => {
        ...
        if (!input)
            return 'Provide some text to capitalize.';
...
(0, framework_1.staticCommand)({
    ...
    content: (i) => {
        ...
        for (let n = 0; n < len; n++)
            out += chars[arr[n] % chars.length];
        return `Generated password (\`${len}\` chars):\n\`${out}\``;
    },
    builder: (b) => b.addIntegerOption((o) => o.setName('length').setDescription('Length (default 16)').setMinValue(6).setMaxValue(64)),
});
